...
| [:simple-perforce: __Perforce Helix Core__](../../assets/packer/helix-core.md)         | An Amazon Machine Image used for provisioning Helix Core on AWS. This AMI is required for deployment of the [Perforce Helix Core module](../../modules/perforce/helix-core/helix-core.md) |
